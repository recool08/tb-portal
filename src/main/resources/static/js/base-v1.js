 ...
 */
function login() {
    return location.href = "http://172.17.203.121:8084/page/login";
}
function regist() {
    return location.href = "http://172.17.203.121:8084/page/register";
}
function logout(redirect) {
    location.href = "http://172.17.203.121:8084/user/logout?redirect=" + redirect;
}
...
function search(a) {
    var b = "http://172.17.203.121:8081/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
