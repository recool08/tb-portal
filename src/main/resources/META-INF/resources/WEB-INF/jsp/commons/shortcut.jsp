		...
		<ul class="fr lh">
			<c:choose>
				<c:when test="${empty user}">
					<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b"><a href="javascript:login()">[登录]</a>&nbsp;<a href="javascript:regist()">[免费注册]</a></li>
				</c:when>
				<c:otherwise>
					<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">${user.username}，欢迎来到淘淘！<a href="javascript:logout(location.href)">[退出]</a>&nbsp;</li>
				</c:otherwise>
			</c:choose>
