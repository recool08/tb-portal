...
public class ItemServiceImpl implements ItemService {
	...
	@Reference
	private com.taotao.rest.service.ItemService itemService;
	...
	public String getItemParam(Long itemId) {
		try {
			...
			System.out.println("================================7777777777777777777=================================" + json);
	...
	/**
	 * 查询首页展示商品
	 * <p>Title: getHotItems</p>
	 * <p>Description: </p>
	 * @param 
	 * @return
	 */
	public List<TbItem> getHotItems() {
		try {
			TaotaoResult taotaoResult = itemService.getHotItems();
			
			if(taotaoResult.getStatus() == 200) {
				return (List<TbItem>) taotaoResult.getData();
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
